...
xticklabels(lineNumLv);
xlabel('Number of Lines', 'FontName', 'Times New Roman', 'FontSize', FontSize_Label, 'FontWeight', 'bold');
...
set(gca, 'FontName', 'Times New Roman', 'FontSize', FontSize_Tick, 'YScale', 'log', ...
    'XTick', [0:interval_size:interval_size*(n-1)], 'LineWidth', 1, 'FontWeight', 'bold', 'YLim', [1e-1 1e3]);
xticklabels(lineNumLv);
xlabel('Number of Lines', 'FontName', 'Times New Roman', 'FontSize', FontSize_Label, 'FontWeight', 'bold');
